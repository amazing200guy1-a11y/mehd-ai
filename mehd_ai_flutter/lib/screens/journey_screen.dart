    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'The Den tracks every action to find your distinct failure patterns.',
            style: MehdAiTheme.labelStyle,
          ),
          const SizedBox(height: 20),
          _buildDNATrait('REVENGE TRADING', '42% of losses occur within 1 hour of a previous loss. You revenge trade when emotional.', 0.8),
          const SizedBox(height: 16),
          _buildDNATrait('SESSION IGNORANCE', 'You ignore the Research Room during high-impact news on USD pairs.', 0.6),
          const SizedBox(height: 16),
          _buildDNATrait('OVER-LEVERAGING', 'You risk 3% instead of 1% when on a winning streak. Arrogance detected.', 0.9),
        ],
      ),
    );
  }
