...
class _ZenChartState extends State<ZenChart> with SingleTickerProviderStateMixin {
  ...
  ManualDrawingTool _activeTool = ManualDrawingTool.none;
  final List<ManualDrawing> _manualDrawings = [];
    ...
    return Container(
      ...
      child: Stack(
        children: [
                    ...
                    child: SizedBox(
                      ...
                      child: Stack(
                        children: [
                          ...
                          RepaintBoundary(
                            child: Opacity(
                              opacity: _drawingMode == DrawingMode.manual ? 0.2 : 1.0,
          ...
          // ── Manual Drawing Toolbar (left side) ──
          ...
          // ── Gesture Layer for Drawing Interaction ──
